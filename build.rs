...
fn generate(s: Shell, app: &mut Command, outdir: &Path, file: &str) {
    ...
    clap_complete::generate(s, app, "bb", &mut dest);
}
...
fn main() {
    ...
    generate(Shell::Bash, &mut app, &outdir, "bash/bb");
    generate(Shell::Elvish, &mut app, &outdir, "elvish/bb");
    generate(Shell::Fish, &mut app, &outdir, "fish/bb");
    generate(Shell::PowerShell, &mut app, &outdir, "powershell/bb");
    generate(Shell::Zsh, &mut app, &outdir, "zsh/_bb");
}
